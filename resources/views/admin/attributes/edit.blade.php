                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group bmd-form-group">
                                            ...
                                            <input type="text" name="attribute_type" class="form-control" value="{{ $attribute->attribute_type }} " >
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group bmd-form-group">
                                            ...
                                            <input type="text" name="values" class="form-control" value="{{ $attribute->values }}" >
                                        </div>
                                    </div>
                                </div>
